...
CREATE TABLE HoldDatabaseEntity (Id INTEGER IDENTITY PRIMARY KEY, BookId UNIQUEIDENTIFIER NOT NULL, PatronId UNIQUEIDENTIFIER NOT NULL, LibraryBranchId UNIQUEIDENTIFIER NOT NULL, PatronDatabaseEntity INTEGER NOT NULL, Till TIMESTAMP NOT NULL);